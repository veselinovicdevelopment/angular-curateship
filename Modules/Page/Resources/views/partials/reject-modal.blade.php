<!-- 👇 Full Screen Modal -->
<form action="#" id="formRejectPage">
  @csrf
  <input type="hidden" id="pageId" value="">
  <div class="custom-modal modal modal--animate-translate-down flex flex-center bg-contrast-higher bg-opacity-90% padding-md js-modal custom-modal-hide-body-scroll custom-disable-modal-close" id="modal-reject-page">
